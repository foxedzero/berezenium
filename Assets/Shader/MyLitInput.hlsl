...
UNITY_DOTS_INSTANCING_START(MaterialPropertyMetadata)
    ...
    //UNITY_DOTS_INSTANCED_PROP(float , _HeightAmount)
    //UNITY_DOTS_INSTANCED_PROP(float , _UVDelta)
...
//static float  unity_DOTS_Sampled_HeightAmount;
//static float  unity_DOTS_Sampled_UVDelta;
...
void SetupDOTSLitMaterialPropertyCaches()
{
    ...
    //unity_DOTS_Sampled_HeightAmount              = UNITY_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float , _HeightAmount);
    //unity_DOTS_Sampled_UVDelta              = UNITY_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float , _UVDelta);
}
...
//#define _HeightAmount                unity_DOTS_Sampled_HeightAmount
//#define _UVDelta                unity_DOTS_Sampled_UVDelta
